...
const tabs = () => {
  ...
  function tabsDo(_ref) {
    ...
    // на таб
    content = document.querySelectorAll(contentSelector); // Скрытие всего контента и удаление класса
    ...
    header.addEventListener('click', e => {
      if (e.target && (e.target.matches(tabsSelector) || e.target.parentNode.matches(tabsSelector))) {
        tabs.forEach((tab, i) => {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _writeOnlyNumbers__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./writeOnlyNumbers */ "./src/js/modules/writeOnlyNumbers.js");
...
const windowOptions = objOption => {
  ...
  (0,_writeOnlyNumbers__WEBPACK_IMPORTED_MODULE_0__["default"])('#width');
  (0,_writeOnlyNumbers__WEBPACK_IMPORTED_MODULE_0__["default"])('#height');
...
/* harmony default export */ __webpack_exports__["default"] = (windowOptions);

/***/ }),

/***/ "./src/js/modules/writeOnlyNumbers.js":
/*!********************************************!*\
  !*** ./src/js/modules/writeOnlyNumbers.js ***!
  \********************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony default export */ __webpack_exports__["default"] = (writeOnlyNumbers);
